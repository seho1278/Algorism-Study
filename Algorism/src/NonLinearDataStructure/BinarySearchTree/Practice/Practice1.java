package NonLinearDataStructure.BinarySearchTree.Practice;
...
class BinarySearchTree {
    ...
    BinarySearchTree() {}
    BinarySearchTree(int key) { this.head = new Node(key, null, null); }

    public void addNode(int key) { this.head = this.addNode(this.head, key); }
